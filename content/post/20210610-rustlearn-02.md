---
title: "Rust学习 02"
date: 2021-06-10T16:49:51+08:00
lastmod: 2021-06-10T16:49:51+08:00
draft: false
summary: "今天我们来看看第三章，**Common Programming Concepts**"
katex: true
mermaid: true
comments: true
tags: ["Rust", "Notes"]
...
从这一章的标题，**Common Programming Concepts**，我们就可以清晰地看出这一章讲的是`Rust`这门编程语言的基础内容，即 *变量*，*函数* 等等概念
...
因为这是可能出现 *bug* 的地方，`Rust`出于安全考虑，设计成了可变和不可变，就是为了防止一些变量本来存储了一个值，不能够改变，但在无意之中被其他程序给改变的情况，因为这种错误是极难被发现的
