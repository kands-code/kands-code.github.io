...
```math
f\left(\lbrace x_0,\ x_1,\ \dots \rbrace \right) \to \mathbb{B}
```

其中 `$x_i$` 的范围是 `$0$` 或 `$1$`，`$\mathbb{B}$` 用 `$0$` 或 `$1$` 表示
...
2. 将 _Hadamard_ 门[^5] 应用到每一个 qubit 上
   ...
   ```math
   \ket{\psi_1} = \dfrac{1}{\sqrt{2^{n + 1}}}
     \sum_{x = 0}^{2^n - 1}\ket{x} \left(\ket{0} - \ket{1} \right)
   ```
...
![some example](../../assets/qiskit-Deutsch-Jozsa-algorithm-pic02.svg)
...
![some example](../../assets/qiskit-Deutsch-Jozsa-algorithm-pic03.svg)
...
![output02](../../assets/qiskit-Deutsch-Jozsa-algorithm-pic05.png)
...
![output03](../../assets/qiskit-Deutsch-Jozsa-algorithm-pic06.png)
...
![output04](../../assets/qiskit-Deutsch-Jozsa-algorithm-pic07.png)
...
![output05](../../assets/qiskit-Deutsch-Jozsa-algorithm-pic08.png)
...
![output06](../../assets/qiskit-Deutsch-Jozsa-algorithm-pic09.png)
...
![output08](../../assets/qiskit-Deutsch-Jozsa-algorithm-pic11.png)
...
![output09](../../assets/qiskit-Deutsch-Jozsa-algorithm-pic12.png)
