...
![缩进错误](../../assert/sagemath-0x02-pic01.png)
...
[^1]:
    可迭代对象.Python Docs \[DB/OL\].(2024-08-29)\[2024-08-31\].
    [https://docs.python.org/zh-cn/3/glossary.html#term-iterable](https://docs.python.org/zh-cn/3/glossary.html#term-iterable)
