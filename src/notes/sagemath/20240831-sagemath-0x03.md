...
<div style="text-align: center;">
  <img src="../../assert/sagemath-0x03-pic01.png" width="64%" alt="函数图像-01">
</div>
...
基于 PARI/GP[^3]，GAP[^4]，以及 Maxima，SageMath 中有许多正交多项式以及特殊函数，例如 **贝塞尔函数** 等等
...
[^1]:
    列表推导式 \[DB/OL\].(2024-08-29)\[2024-08-31\].
    [https://docs.python.org/zh-cn/3/tutorial/datastructures.html#list-comprehensions](https://docs.python.org/zh-cn/3/tutorial/datastructures.html#list-comprehensions)

[^2]:
    Maxima: v5.47 \[CP/OL\].(2023-05-31)\[2024-08-31\].
    [https://maxima.sourceforge.io/zh/index.html](https://maxima.sourceforge.io/zh/index.html)

[^3]:
    Pari/GP: v2.15.5 \[CP/OL\].(2024-02-11)\[2024-08-31\].
    [https://pari.math.u-bordeaux.fr](https://pari.math.u-bordeaux.fr)

[^4]:
    GAP: v4.13.1 \[CP/OL\].(2024-06-11)\[2024-08-31\].
